...
import 'package:construction2/Add_stock/AddStock_form.dart';
...
class AddStock extends StatefulWidget {
  @override
  _AddStock createState() => _AddStock();
}

class _AddStock extends State<AddStock> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: TextBuilder(text: "Add Stock",fontWeight: FontWeight.bold,textAlign: TextAlign.center,),
      ),
      body: Column(
        ...
        children: [
          SizedBox(height: 15,),
          Image.asset(
            'assets/icons/addStock.png', // Replace with your logo image path
            height: 180,
            width: 210,
          ),
          SizedBox(height: 25,),
