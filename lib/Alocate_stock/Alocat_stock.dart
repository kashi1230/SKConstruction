...
class AlocateStock extends StatefulWidget {
  @override
  _AlocateStock createState() => _AlocateStock();
}

class _AlocateStock extends State<AlocateStock> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: TextBuilder(text: "Alocate Stock",fontWeight: FontWeight.bold,textAlign: TextAlign.center,),
      ),
      body: Column(
        ...
        children: [
          SizedBox(height: 15,),
          Image.asset(
            'assets/icons/alocate.png', // Replace with your logo image path
            height: 180,
            width: 210,
          ),
          SizedBox(height: 25,),
